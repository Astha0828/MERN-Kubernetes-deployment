...
import { getAllBatch,getAllPlacementOpportunity, getStudentByBatch, getAllStudent } from "../../api/Api";
...
const AllPlacement = () => {
  ...
  const showCompletePlacementStat = (id) => {
    console.log(id)
      setCookie("sid", id);
      navigate(`/placementDetails`);
  };
          ...
          <TableHead>
            {getBatchDetails === "All" && (
              <TableRow>
                ...
                <StyledTableCell align="left">Internal Round</StyledTableCell>
                <StyledTableCell align="left">Qualified Skill</StyledTableCell>
                <StyledTableCell align="left">Job application Id</StyledTableCell>
                <StyledTableCell align="left">Applied Companies</StyledTableCell>
                <StyledTableCell align="left">General Remark</StyledTableCell>
              </TableRow>
            )}
            {getBatchDetails !== "All" && (
              <TableRow>
            ...
            {filterStudent &&
              getStudent.map((student) => (
                <StyledTableRow
                  ...
                  key={student._id}
                  onClick={() => showCompletePlacementStat(student.studentId)}
                >
            ...
            {getBatchDetails === "All" &&
              allOpportunity.map((student) => (
                ...
                >
                  ...
                  <StyledTableCell align="left">
                    {student.internalRoundStatus ? "Cleared" : "Not Cleared"}
                  </StyledTableCell>
                  <StyledTableCell align="left">
                    {student.studentQualifiedSkill}
                  </StyledTableCell>
                  <StyledTableCell align="left">
                    {student.appliedIn}
                  </StyledTableCell>
                  <StyledTableCell align="left">
                    {student.companyNameApplied}
                  </StyledTableCell>
                  <StyledTableCell align="left">
